...
brother_rule = IF(AND('parent (?x) (?y)','parent (?x) (?z)','male (?y)',NOT('same-identity (?y) (?z)')),THEN('brother (?y) (?z)'))
sister_rule = IF(AND('parent (?x) (?y)','parent (?x) (?z)','female (?y)',NOT('same-identity (?y) (?z)')),THEN('sister (?y) (?z)'))
mother_rule = IF(AND('female (?x)','parent (?x) (?y)'),THEN('morhter (?x) (?y)'))
...
cousin_rule = IF(AND('parent (?x) (?z)','parent (?y) (?t)',OR('brother (?x) (?y)','sister (?x) (?y)')),THEN('cousin (?z) (?t)'))
...
family_rules = [ same_identity, brother_rule, sister_rule, mother_rule, father_rule, son_rule, daughter_rule, cousin_rule, grandparent_rule, grandchild_rule ]                    # fill me in
                 # fill me in
